...
export default function Promote({ prevStep ,form , images }) {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-10 grid grid-cols-3 gap-8">
      ...
      {/* ================= LEFT ================= */}
      <div className="col-span-2 bg-white p-8 rounded-2xl border shadow-sm border-gray-200">
    ...
    >
      ...
      <div className="sticky top-24 h-fit">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-7 shadow-xl">
          ...
          {!timeSlot && (
            <p className="text-gray-500">Select time slot first</p>
          )}
...
function StandCard({ title, desc, price, active, setActive, highlightAll=false }) {
  return (
    <div className="border border-gray-200 rounded-2xl p-6 mb-6 bg-gray-50 flex justify-between items-center">
